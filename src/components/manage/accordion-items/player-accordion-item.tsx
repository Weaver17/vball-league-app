...
type PlayerAccordionItemProps = {
    teamId: string;
    teamName: string;
    currentPlayerId: string;
};

function PlayerAccordionItem({
    teamId,
    teamName,
    currentPlayerId,
                ...
                {playerTeam.players && playerTeam.players.length > 0 ? (
                    playerTeam.players
                        ...
                        .map((p: Player) => (
                            <div
                                key={p.id}
                                className="flex items-center justify-between gap-2 px-2 border-b border-foreground pb-2 last:border-b-0"
                            >
                                <p>
...
export default PlayerAccordionItem;
