...
import RemoveTeamModal from "@/components/app/modals/remove-team-modal";

type CommishAccordionItemProps = {
    leagueId: string;
    leagueName: string;
};

function CommishAccordionItem({
    leagueId,
    leagueName,
}: CommishAccordionItemProps) {
...
export default CommishAccordionItem;
